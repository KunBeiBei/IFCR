...
if __name__ == '__main__':
    ...
    torch.save(recall10,  'jeg/T/MBRS/recall10.pth')
    torch.save(recall50,  'jeg/T/MBRS/recall50.pth')
    torch.save(recall100, 'jeg/T/MBRS/recall100.pth')
    torch.save(ndcg10,    'jeg/T/MBRS/ndcg10.pth')
    torch.save(ndcg50,    'jeg/T/MBRS/ndcg50.pth')
    torch.save(ndcg100,   'jeg/T/MBRS/ndcg100.pth')
    torch.save(losss,     'jeg/T/MBRS/loss.pth')
